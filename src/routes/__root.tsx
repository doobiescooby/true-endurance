    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-border bg-background px-6 py-2.5 text-sm font-medium transition-colors hover:bg-accent"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Stamina Rocket — Natural training for lasting control" },
      {
        ...
        content:
          "A calm, science-based daily program for men. Build lasting control, confidence, and connection — privately.",
      },
